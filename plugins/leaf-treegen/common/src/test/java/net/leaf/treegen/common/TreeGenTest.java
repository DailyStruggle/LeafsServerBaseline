...
public class TreeGenTest {
    ...
    void testCacheEvictionOnMReuses() {
        ...
        TreeSpecies species = new TreeSpecies("eviction_test", "Eviction", "ns", "gp", Set.of(), "OAK", true, false, 3, 2, -1, "linear", "step", List.of(), null, null, null);
    ...
    void testCacheEfficiency() {
        MockPlatform platform = new MockPlatform();
        TreeRegistry registry = new TreeRegistry(platform);
        TreeSpecies species = new TreeSpecies("cache_test", "Cache", "ns", "gp", Set.of(), "OAK", true, false, 3, 2, -1, "linear", "step", List.of(), null, null, null);
        ProceduralGenerator generator = new ProceduralGenerator(platform, registry);
    ...
    public void testTrunkLogicParity() {
        ...
        TreeSpecies species = new TreeSpecies("parity", "Parity", "ns", "gp", Set.of(), "OAK", true, false, 3, 2, -1, "linear", "step", List.of(), params, null, null);
